...
INSERT INTO address (id, single_line_address, postcode) VALUES
    (8500800001, 'Correspondence address for property row 1', 'CO1 1CO'),
    (8500800002, 'Correspondence address for property row 2', 'CO1 1CO'),
    (8500800003, 'Correspondence address for property row 3', 'CO1 1CO');
...
VALUES (1, true, 1, 1, 2, 2, 2, current_date, 1, 1, null, null, 2, 1, null, 123.12, true, 'email@example.com', 8500800001),
       (2, true, 1, 1, 2, 3, 3, current_date, 1, 1, null, null, 2, 1, null, 123.12, true, 'email@example.com', 8500800002),
       (3, true, 1, 1, 2, 4, 4, current_date, 1, 1, null, null, 2, 1, null, 123.12, true, 'email@example.com', 8500800003);
