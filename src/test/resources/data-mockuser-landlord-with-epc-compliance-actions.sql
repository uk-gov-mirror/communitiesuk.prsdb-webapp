...
VALUES (1, true, 1, 1, 2, 2, 2, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       ...
       (6, true, 1, 0, 0, 7, 7, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (7, true, 1, 1, 2, 8, 8, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (8, true, 1, 0, 0, 9, 9, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (9, true, 1, 1, 2, 10, 10, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (10, true, 1, 0, 0, 11, 11, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (11, true, 1, 1, 2, 12, 12, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (12, true, 1, 0, 0, 13, 13, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (13, true, 1, 1, 2, 14, 14, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (14, true, 1, 0, 0, 15, 15, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (15, true, 1, 1, 2, 16, 16, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (16, true, 1, 0, 0, 17, 17, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (17, true, 1, 1, 2, 18, 18, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (18, true, 1, 0, 0, 19, 19, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1),
       (19, true, 1, 1, 2, 20, 20, current_date, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1),
       (20, true, 1, 0, 0, 21, 21, current_date, 1, null, null, null, null, null, null, null, null, false, 'email@example.com', 1);
...
INSERT INTO property_ownership (id, is_active, ownership_type, current_num_households, current_num_tenants, registration_number_id, address_id, created_date, property_build_type,
                                num_bedrooms, bills_included_list, custom_bills_included, furnished_status, rent_frequency, custom_rent_frequency, rent_amount, last_occupied_date, is_occupied, correspondence_email, correspondence_address_id)
VALUES (21, true, 1, 1, 2, 22, 22, current_date - 100, 1, 1, null, null, 2, 1, null, 123.12, current_date, true, 'email@example.com', 1);
